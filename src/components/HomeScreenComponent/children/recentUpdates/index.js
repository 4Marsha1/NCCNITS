        ...
        <>
            ...
            <div className={styles['updates-content']}>
                ...
                <div className={styles['content']}>
                    <img className={styles['updates-img']} src='https://picsum.photos/200'  alt ="iamge"/>
                    <div className={styles['updates-text']}>
                        Combined Annual Training Camp-2018 for boys was held at location karumganj from 4th February to 13th February 2018, in which approx. 32 boys from NITS participated in the camp. The cadets were exposed to the following activities during the camp:- <br />
            ...
            <div className={styles['updates-content']}>
                ...
                <div className={`${styles['content']} ${styles['mobile-view']}`}>
                    ...
                    <img className={styles['updates-img']} src='https://picsum.photos/200' alt="img"/>
                </div>
            </div>
        </>
    )
