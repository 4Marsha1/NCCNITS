...
const index = ({ type }) => {
    switch (type) {
        case 1: return (
            <div className={styles['tab']}>
                <div className={styles['img']}>
                    <img src='http://www.nits.ac.in/campuslife/ncc_nits/images/1%20(4).jpg' />
                </div>
        ...
        case 2: return (
            <div className={styles['tab']}>
                <div className={styles['img']}>
                    <img src='http://www.nits.ac.in/campuslife/ncc_nits/images/1%20(72).jpg' />
                </div>
                <div className={styles['content']}>
                    <p>
                        NCC at NITS is an organisation cum family engaged in conducting constructive activities for all the cadets under its fold and one of them is <strong>CLOTH DONATION</strong>. NCC,NITS proudly holds the responsibility of being future harbingers of the country by actively participating in social activities. Cloth donation camps are organised twice in a year. Under it, every hostel is provided with a Container in which the boarders are requested to donate clothes and stationery items for the nearby poor villagers. After few days, the donated stuffs are being collected by NCC Cadets. And it is being provided to the poor and needy persons of nearby villages
                    </p>
                </div>
            </div>
        )
