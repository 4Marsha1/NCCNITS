const faqs = [{
    id: 1,
    qns: "1. What is National Cadet Corps ?",
...
{
    id: 2,
    qns: "2. When did National Cadet Corps Come into existence?",
...
{
    id: 3,
    qns: "3. What is the nature of the NCC Programme, whether compulsory or voluntary?",
    ans: "Voluntary."
},
{
    id: 4,
    qns: "4. Is the NCC Programme part of the Educational activity or is it a part of military activity?",
    ans: "Educational Activity."
},
{
    id: 5,
    qns: "5. What is/are the Aim(s) of NCC?",
    ans: `<ul>
        ...
        leadership,
        secular outlook,
        sprit of adventure and the ideals of selfless service amongst the youth of the country. </li> 
        <li>
        To create a human resource of organized,
        trained and motivate youth to provide leadership in all walks of life and always available
        for the service of the nation. </li> 
        <li>
        To provide a suitable environment to motivate the youth to take up a career in the Armed Forces. </li> 
        </ul> `
},
{
    id: 6,
    qns: "6. What is the Motto of NCC?",
    ans: `<p>The motto of NCC is:<b>" UNITY AND DISCIPLINE ". </b> </p>`
},
{
    id: 7,
    qns: "7. What is the NCC symbol/insignia?",
...
{
    id: 8,
    qns: "8. What does the colour Red depicts in the NCC Crest?",
    ans: "Red depicts the Army."
},
{
    id: 9,
    qns: "9. What do the colours Dark Blue and Light blue in the NCC Crest depict?",
    ans: "Deep Blue depicts the Navy and Light Blue depicts the Air Force."
},
{
    id: 10,
    qns: "10.What do the Lotus flowers depicts in NCC Crest?",
    ans: "The seventeen lotuses represent the 17 State Directorates."
},
{
    id: 11,
    qns: "11.When is the NCC Day observed?",
    ans: "The NCC Day is observed on the four Sunday of November."
},
{
    id: 12,
    qns: "12.Which Ministry at the National level deals with NCC?",
    ans: "The Ministry of Defence."
},
{
    id: 13,
    qns: "13.Which Ministry deals with NCC in all States?",
    ans: "Education."
},
{
    id: 14,
    qns: "14.What are the arrangements for Finances/Funds for NCC?",
    ans: "The funds are shared by the Central and State Govts."
}, {
    id: 15,
    qns: "15.What is Directorate General NCC?",
    ans: " It is the national level HQ."
}, {
    id: 16,
    qns: "16.What is the composition of Directorate General NCC?",
    ...
    id: 17,
    qns: "17.Where is the NCC Headquarter at the National level located?",
    ans: "At New Delhi."
}, {
    id: 18,
    qns: "18.What is a NCC Directorate?",
    ...
    id: 20,
    qns: "20.What is the composition of a NCC Group?",
...
{
    id: 27,
    qns: "27.What is a NCC Troop?",
    ans: "The basic functional sub-unit in schools, having JW/JD Cadets, is a Troop."
},
{
    id: 28,
    qns: "28.How many NCC units can be allotted to an institution?",
    ans: "There are no fixed numbers."
},
{
    id: 29,
    qns: "29.Who is responsible for the conduct of NCC activities in an institution?",
...
{
    id: 30,
    qns: "30.NCC Officer (ANO) is the main key functionary of NCC in Colleges/ Schools. What role does the Head Master/Principal play in the implementation of this program?",
...
{
    id: 31,
    qns: "31.Do ANO's get orientation training enabling them to undertake their NCC responsibilities?",
    ans: "Yes."
},
{
    id: 32,
    qns: "32.What is the age limit for a student to join NCC?",
    ans: " For JD/JW Cadets : 13-18.5 Years and For SD/SW Cadets : Upto 24 years of age."
},
{
    id: 33,
    qns: "33. Are there any Physical Criterion for a Student to join NCC? If so what are they?",
    ans: " Yes. They are specified at Rule 5(d) and 6(d) of the NCC Rules."
},
{
    id: 34,
    qns: "34.Are any fees to be paid for enrolment as an NCC Cadet?",
...
{
    id: 35,
    qns: "35.What is the duration of the NCC Programme as an NCC Cadet?",
    ans: " For JD/JW Cadets: Two Years and For SD/SW Cadets: Two Years with one year extension."
},
{
    id: 36,
    qns: "36.What is the uniform in NCC ?",
...
{
    id: 38,
    qns: "38.As a JD/JW Cadet what NCC certificate will I earn?",
    ans: "'A' Certificate."
},
{
    id: 39,
    qns: "39.As a SD/SW cadet what NCC certificate(s) will I earn?",
    ans: "'B'and 'C' Certificates."
},
{
    id: 40,
    qns: "40.Is it compulsory to attend NCC Camps?",
    ans: "Yes."
},
{
    id: 41,
    qns: "41.What are the various types of Camps in NCC?",
    ans: `<ol> 
        <li>Annual Training Camp(ATC) </li> 
        <li>Centrally Organised Camps(COC) 
        <ul>
...
{
    id: 42,
    qns: "42.What sort of activities are undertaken in NCC?",
    ans: `<p> Activities in NCC are categorized as under: - </p>
        <ul> 
        <li >Institutional Training </li> 
        <li >Camp Training </li>
        <li >Attachment Training(Service Unit) </li> 
        <li >Air wing Training </li> 
        <li >Naval wing Training </li> 
        <li >Social Service and Community Development Activities. </li> 
        <li >Youth Exchange Program </li> 
        <li >Conduct of Republic Day Camp </li> 
        <li >Conduct of course at OTA Kamptee and OTA Gwalior for ANO 's. </li> 
        <li >
        Career Counselling and Personality Development. </li> 
        <li >Remount & Veterinary Unit Training. </li> 
        <li >Conduct of Certificate Examinations. </li> 
        <li >Conduct of Adventure Activities. </li> 
        </ul>`
},
{
    id: 43,
    qns: "43.Can I get any award for some extraordinary work/performance?",
...
{
    id: 44,
    qns: "44.Can I get any chance for visiting other States in the country or abroad? How?",
    ans: "Yes. If you are selected for Centrally Organised Camps/Youth Exchange Programme."
},
{
    id: 45,
    qns: "45.How will NCC be useful in developing my personality?",
    ans: "Please see the Aims of NCC at FAQ 5."
},
{
    id: 46,
    qns: "46.How can I participate in the Republic Day Parade at Rajpath in New Delhi?",
...
{
    id: 47,
    qns: "47.Does NCC organize National Integration Camps?",
    ans: "Yes."
},
{
    id: 48,
    qns: "48.Does NCC celebrate International and National days, Weeks etc?",
    ans: "Yes."
},
{
    id: 49,
    qns: "49.Am I supposed to participate in election campaigns, rallies as an NCC Cadet?",
    ans: "No."
},
{
    id: 50,
    qns: "50.Am I supposed to administer injections during immunization programmes ?",
    ans: "No."
},
{
    id: 51,
    qns: "51.Can I involve myself in 'Tree Plantations' How many saplings will I have to plant in a year and will I get any certificate?",
    ans: "Yes. There are no fixed numbers. A certificate is awarded."
},
{
    id: 52,
    qns: "52.Can I donate blood during Blood Donation camps?",
    ans: "Yes."
},
{
    id: 53,
    qns: "53.Is it compulsory to donate blood for an NCC cadet?",
    ans: "No."
},

{
    id: 54,
    qns: "54.Is it compulsory to donate organs for an NCC cadet?",
    ans: "No."
},
{
    id: 55,
    qns: "55.Is Army, Air Force and Navy training given to an NCC cadet, and if so with what purpose?",
...
{
    id: 56,
    qns: "56.If I join NCC is it compulsory for me to join the Armed Forces thereafter?",
    ans: "No."
},
{
    id: 57,
    qns: "57.How many States/UT does NCC cover all over the country?",
    ans: " All the states and Union Territories."
},
{
    id: 58,
    qns: "58.Is this scheme applicable to only Govt Schools & Colleges?",
    ans: "No. However financial arrangements, with regard to expenditures varies depending on the type of the institution."
},
{
    id: 59,
    qns: "59.What sort of remuneration does an ANO get in NCC?",
    ans: `<p > Remunerations received are: - </p>
        <ul> 
        <li >Monthly Honorarium. </li> 
        <li >Outfit Allowance. </li> 
        <li >Outfit Maintenance Allowance. </li> 
        <li >Travel and Messing Expenses for Pre - commission and Refresher courses. </li> 
        <li >Rank Pay during Camps. </li> 
        <li >TA and DA for journey for move to/move back from camps. </li>
        </ul>`
},
{
    id: 60,
    qns: "60.Do NCC units have any connection with other voluntary organizations?",
    ans: "Yes; in implementing Community Development and Social service activities."
},
{
    id: 61,
    qns: "61.Are NCC cadets exposed to work in Natural disasters & calamities?",
    ans: "Yes. With permission of parents of cadets."
},
{
    id: 62,
    qns: "62.Can I ever get any chance to meet some eminent personalities/ celebrities while working in NCC?",
    ans: "Yes."
}
];
