const aboutNcc = [
    {
        ...
        lads of the country into disciplined and patriotic citizens. The NCC is a youth development 
        movement and has enormous potential for nation-building. The Cadets are designated with basic 
    ...
    },
    {
        ...
        should be formed, which could train more young men in a better way, even during peace times. A committee headed 
        by Pandit H.N. Kunzru recommended a cadet organization to be established in schools and colleges at a national level. 
        The National Cadet Corps Act was accepted by the Governor General and on 15 July 1948 the National Cadet Corps came into existence.<br/>
        <br/>
        During the 1965 and 1971 wars with Pakistan, NCC cadets were the second line of defence. They organised camps to assist 
        the ordnance factories, supplying arms and ammunition to the front, and also were used as patrol 
        parties to capture the enemy paratroopers. The NCC cadets also worked hand in hand with the Civil 
        Defence authorities and actively took part in rescue work and traffic control. After the 1965 and 1971 Indo-Pak 
        ...
        desc: [
            ...
            },
            {
                ...
                content: `<ul>
                    ...
                    <li>2. To create a human resource of organized, trained and motivated youth to provide leadership 
                    in all walks of life including the Armed Forces and be always available for the service of the nation.</li>
                    <li>3. To Provide a Suitable Environment to Motivate the Youth to Take Up a Career in the Armed Forces.</li>
    ...
    },
    {
        ...
        content: `HUM SAB BHARTIYA HAI, HUM SAB BHARATIYA HAI<br/>
                ...
                SADIYON SE HUMNE ISKO APNE KHOON SE PALA HAI<br/>
                DESH KI RAKSHA KI KHATIR, HUM SHAMSHEER UTHA LENGE<br/>
                HUM SHAMSHEER UTHA LENGE<br/>
                BIKHRE BIKHRE TARE HAI HUM LEKIN JHILMIL EK HAI<br/>
                HA HA HA HA EK HAI, HUM SAB BHARTIYA HAI<br/>
                MANDIR GURDWARE BHI HAI YAHAN, AUR MASJID BHI HAI YAHAN<br/>
                GIRJA KA GHARIYAL KAHIN MULLA KI KANKHI HAI AJAAN<br/>
                EK HI APNA RAM HAI, EK HI ALLAH TAALA HAI<br/>
                EK HI ALLAH TAALA HAI<br/>
    ...
    },
    {
        ...
        <br/>
        <ul>    
        <li>1.	Republic Day Camp (RDC) </li>
        <li>2.	Leadership Camp</li>
        <li>3.	Thal Sainik Camp (TSC)</li>
        <li>4.	Vayu Sainik Camp</li>
        <li>5.	Nau Sainik Camp</li>
        <li>6.	Army Attachment Camp (AAC)</li>
        <li>7.	Airforce Attachment Camp (AAC)</li>
        <li>8.	National Integration Camp (NIC)</li>
        <li>9.	Annual training Camp(ATC)</li>
    ...
    },
    {
        ...
        training for a minimum period of 75% of total hours during the annual college and school session. Every cadet (in the case of JD, 
        who has completed one full year of training and is in his second year) attends an annual training camp of 9–10 days, also known 
        as the National Combined Annual Training Camp. For SD/SW the duration is usually up to 30 days. At the end of the camp training, 
        the cadets receive a certificate of successful completion.<br/>
        <br/>
        Drill, firing, Physical fitness, map reading, First aid, Gliding/Flying, boat pulling, sailing, and camp training covering the 
        basics of military training in the Army, Navy, and Air Force.<br/>
        <br/>
        This training is mostly carried out in schools and colleges by the cadets. In addition, depending upon the type of service, 
        basic knowledge of that service is imparted to the cadets e.g gliding, powered flying for Air Wing cadets, and boat pulling, 
        sailing for Naval Wing cadets form part of institutional training. These activities comprise approximately 50% of the entire 
        syllabus.<br/>
        <br/>
        This is the most foremost aspect of NCC Training and hence the great emphasis on institutional training is to be given. 
        State DDG's to issue comprehensive instructions on organizing the Institutional Training at Group / Unit level. <br/>
        Following actions will be taken to improve the standard of training. <br/>
        <br/>
        <ol>
        <li>Optimum utilization of PI Staff for Training. </li>
        ...
        desc: [
            {
                ...
                <br/>
                    <ul>
                        <li>Certificate 'A' : Junior Division/Wing NCC </li>
            ...
            },
            {
                ...
                for the first and second years of Junior Division/Wing NCC(All wings)</li>
                <li>4.	Break in the NCC Service of the cadet prior to his appearance. In the examination 'should not exceed more 
                than 12 month at one time, to count his previous service. In case the break exceeds 12 months, the following 
                procedure will be adopted <br/>
                "If he has been on the unit rolls for a minimum of two years before his discharge and had attended 75% of the 
                total period during his NCC Service he will need another 45 periods of training to become eligible for certificate 
            ...
            },
            {
                ...
                <li>4.	The cadet must have attended a minimum of 75% of the total training period laid down in the syllabus for the 
                first and second years for Senior Division Wing NCC (All Wings). Break in the NCC service of the cadet SD/SE prior 
                to appearing in the exam should not exceed more than 18 months at one time, after his discharge to count his service 
                for Certificate 'B' Examination. In case the break exceeds 18 months the following procedure will be adopted.<br/>
                "If he had been on the unit rolls for a minimum of two years before his discharge and had attended 75% of the total 
                periods during his NCC service he would need another 45 periods of training to become eligible for certificate 'B' 
                Examination. In all other cases where above conditions are not fulfilled, the cadet must attend a minimum 75% periods 
            ...
            },
            {
                ...
                <li>4.	Break in the NCC Service of the SD/SW Cadet prior to appearing in the exam should not exceed more than 18 months 
                at one time, after his discharge to count his previous service for Certificate 'C' examination. In case the break exceeds 
                18 months, the following procedure will be adopted<br/>
                "If he had been on the Unit rolls for a minimum of two years before his discharge and had attended 75% of the total 
                period during his NCC service, he will need another 45 periods of training to become eligible for Certificate 'C' 
                examination. In all other cases where above conditions are not fulfilled, the Cadet must attend a minimum of 75% periods 
            ...
            },
            {
                ...
                <br/>
                <ul>
                <li>1.	Cadets who have obtained a 'C' grading in NCC 'C' Certificate Exam and who wish to improve their grading will be 
                allowed to appear for a retest. Only one retest will be allowed.</li>
                <li>2.	Cadets will have to re-appear in complete examination.</li>
                <li>3.	Retest will be held along with fresh cases next year. During the period, these Cadets may attend at 
                least two weeks' Special Parade/Coaching classes to be organized by units after the academic session. Those Cadets who 
